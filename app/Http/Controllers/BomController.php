...
class BomController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('BomList', compact('boms'));
    }
    ...
    public function create()
    {
        ...
        return view('BomForm', compact('products', 'rawMaterials'));
    }
    ...
    public function show(Bom $bom)
    {
        ...
        return view('BomForm', compact('bom', 'products', 'rawMaterials'))->with('is_show', true);
    }
    ...
    public function edit(Bom $bom)
    {
        ...
        return view('BomForm', compact('bom', 'products', 'rawMaterials'));
    }
