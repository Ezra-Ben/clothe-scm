...
<div class="container py-4">
    <h1 class="mb-4 text-primary">Create New Bill of Materials</h1>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('boms.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="version" id="version" class="form-control @error('version') is-invalid @enderror" value="{{ old('version', 'v1') }}" required>
                    @error('version')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div id="bom-items-container">
                    @if(old('bom_items'))
                        ...
                        @endforeach
                    @else
                        {{-- Show one empty row if none old input --}}
